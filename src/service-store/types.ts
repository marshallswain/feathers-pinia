...
//    */
//   find<M extends BaseModel = BaseModel>(params?: Params): Promise<M[] | Paginated<M>>

//   /**
//    * A proxy for the `findInStore` getter
//    * @param params Find params
//    */
//   findInStore<M extends BaseModel = BaseModel>(params?: Params | Ref<Params>): Paginated<M>
...
//    */
//   get<M extends BaseModel = BaseModel>(id: Id, params?: Params): Promise<M | undefined>
...
//    * @param params Get params
//    */
//   getFromStore<M extends BaseModel = BaseModel>(
//     id: Id | Ref<Id>,
...
//    */
//   addToStore<M extends BaseModel = BaseModel>(
//     data: AnyData
//   ): M
...
//    */
//   update<M extends BaseModel = BaseModel>(id: Id, data: any, params?: Params): Promise<M>
...
//    */
//   patch<M extends BaseModel = BaseModel>(id: NullableId, data: any, params?: Params): Promise<M>
...
export type DefaultServiceStore<
